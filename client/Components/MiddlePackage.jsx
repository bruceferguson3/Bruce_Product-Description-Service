    ...
    return (
        ...
        <div className='b_middlePackage'>
            ...
            <div className='b_buttonContainer'>
                ...
                <button id='b_shoppingListButton' className='b_shoppingListButton'><svg className='b_shoppingListSVG'><path d="M18,18h2v2H18v2H16V20H14V18h2V16h2ZM12,6H6V8h6ZM6,12H8V10H6ZM4,4H14l2-2H2V22H12V20H4ZM5.77,18.29l4.66-2.05L22,4.66,19.34,2,7.72,13.73Z"/></svg>Add to shopping list</button>
            </div>
